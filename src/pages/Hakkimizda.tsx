...
const Hakkimizda = () => {
  const title = "Hakkımızda | İzmir Tadilat Merkezi";
  const description =
    "İzmir Tadilat Merkezi hakkında bilgi alın. İzmir’de profesyonel tadilat çözüm ortakları ile çalışan güvenilir bir yönlendirme platformu.";
        ...
        <section className="py-12 md:py-16 bg-muted/30">
          <div className="container mx-auto px-4 max-w-5xl space-y-6">
            <div className="space-y-3 text-center">
              <p className="text-primary font-medium uppercase tracking-wide">İzmir Tadilat Merkezi</p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-card border border-border rounded-xl p-6 space-y-4 shadow-sm">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  İzmir Tadilat Merkezi, İzmir genelinde deneyimli ustalar ve iç mimarlarla çalışan bir yönlendirme
